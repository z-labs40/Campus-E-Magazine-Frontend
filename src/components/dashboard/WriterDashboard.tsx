    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 select-none">
        <div className="text-left space-y-1">
          ...
          <h1 className="font-sora font-extrabold text-2xl lg:text-3xl text-foreground">My Writer Dashboard</h1>
          <p className="text-muted-foreground text-xs">Create drafts, refine paragraphs, and track review cycles.</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 select-none">
        ...
        <Card className="shadow-premium bg-card border-border/50">
          <CardContent className="pt-6 flex items-center justify-between text-left">
            <div className="space-y-1">
              <span className="text-[10px] uppercase font-bold text-muted-foreground tracking-widest">Published Success</span>
